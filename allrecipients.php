...
$result=mysqli_query($con,"select * from recipient");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>	
		<div class="box">
		<div class="inputbox">
		<h1>JEEVANDAAN RECIPIENT VALIDATION</h1><div class="gogo" style="height: 450px;width: 860px;overflow-y:scroll;">
		...
		<?php 
			...
			while($row=mysqli_fetch_assoc($result)){
				...
				<tr>
					...
					<td align="center"><?php echo "" .$row['validate'];?></td>
	...
	<div style="width: 250px; margin-left: 880px; margin-top: -38%;">
	<td align="center"><form action="validaterec.php" method="post">
	...
	<input type="text" name="hname" id="hname" placeholder="HOSPITAL NAME" size="30">
	...
	<script>
		...
		for(var i=0;i<table.rows.length;i++)
		{
			table.rows[i].onclick = function()
			{
				...
				document.getElementById("hname").value = this.cells[6].innerHTML;
