...
<body>	
		<div class="box">
		<div class="inputbox">
		<h1>JEEVANDAAN DONOR VALIDATION</h1><div class="gogo" style="height: 450px;width: 860px;overflow-y:scroll;">
	...
	<div style="width: 250px; margin-left: 905px; margin-top: -38%;">
	<td align="center"><form action="validate.php" method="post">
